...
> [!NOTE]
> **最新 Pro / Lite 更新** — `ClawPanel Pro v5.2.11` 前端懒加载提升首屏性能、修复 agent/channel 稳定性问题、安装脚本切换 Gitee 入口；`ClawPanel Lite v0.1.11` 修复通道保存凭证覆盖 enabled 导致无法回复消息、修复打包脚本漏删 AGENTS.md 模板、修复飞书 plugin entry key 错误。详见 [changelogs/v5.2.11.md](changelogs/v5.2.11.md) 和 [changelogs/lite-v0.1.11.md](changelogs/lite-v0.1.11.md)
